...
class DocumentMinhashDeduplicatorTest(DataJuicerTestCaseBase):
    ...
    def test_punctuation_deduplication(self):
        ...
        dataset = Dataset.from_list(ds_list)
        op = DocumentMinhashDeduplicator(tokenization="punctuation", ignore_pattern=r"\d")
        self._run_minhash_dedup(dataset, tgt_list, op)
    
    def test_sentencepiece_deduplication(self):
        ds_list = [
            {
                'text': 'Today is Sunday and it\'s a happy day!'
            },
        ...
        dataset = Dataset.from_list(ds_list)
        op = DocumentMinhashDeduplicator(tokenization="sentencepiece", tokenizer_model="en.sp.model")
        self._run_minhash_dedup(dataset, tgt_list, op)
    
    def test_sentencepiece_error(self):
        with self.assertRaises(ValueError):
            op = DocumentMinhashDeduplicator(tokenization="sentencepiece")
    ...
    def test_unimplemented_tokenization(self):
        ...
        dataset = Dataset.from_list(ds_list)
        op = DocumentMinhashDeduplicator(tokenization="unimplemented")
